      ...
      <main className="flex-1 flex flex-col justify-center max-w-sm mx-auto w-full pb-20">
        ...
        >
          <div className="mb-8 text-center -mt-12">
            ...
            <h1 className="text-4xl font-black text-brand-black tracking-tight">Crie sua conta</h1>
            <p className="text-xl text-slate-500 mt-2 font-medium px-4">Junte-se a milhares de outras mulheres</p>
          </div>
